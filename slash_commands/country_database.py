...
class CountryDatabase2(commands.Cog, name='Country Database (slash)', description='Commands that allow you to find countries!'):
  def __init__(self, bot):
    self.bot = bot

  @cog_ext.cog_slash(description='List all countries in the world that start with the letter or letters that you provided.')
