      ...
      if amount.isnumeric():
        if int(amount) > b[0][1]:
          ...
          await ctx.channel.send(embed=embed)
            ...
            await update((user.id, a[0][0], a[0][1] + int(amount), a[0][2], a[0][3], a[0][4], a[0][10]))

            await ctx.channel.send(embed=discord.Embed(title="Success!", description=f"Succesfully transefered {amount} people to {user}'s country!"))
        ...
        if amount.lower() == 'half':
            ...
            await update((user.id, a[0][0], a[0][1] + int(b[0][1]/2), a[0][2], a[0][3], a[0][4], a[0][10]))

            await ctx.channel.send(embed=discord.Embed(title="Success!", description=f"Succesfully transefered {int(b[0][1]/2)} people to {user}'s country!"))

        elif amount.lower() == 'all':
            await update((ctx.author.id, b[0][0], 0, b[0][2], b[0][3], b[0][4], b[0][10]))

            await update((user.id, a[0][0], a[0][1] + b[0][1], a[0][2], a[0][3], a[0][4], a[0][10]))

            await ctx.channel.send(embed=discord.Embed(title="Success!", description=f"Succesfully transefered {int(b[0][1])} people to {user}'s country!"))
...
class Games(commands.Cog, description='Cool games that test your geography skills'):
  ...
  @commands.command(description='Guess capitals of countries, or guess countries from their capitals! This game lasts for ten minutes at max!', brief='Guess capitals of countries, or guess countries from their capitals!')
