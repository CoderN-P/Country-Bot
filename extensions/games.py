...
class EconomyCommands(
    ...
    @commands.command(
        brief="Tax your citizens for coins.", description="Tax your citiens for coins."
    )
    ...
    @commands.command(
        aliases=["lb"],
        description="Shows global leaderboards for coins and prestige. If you do not provide a type, the bot will send you the prestige leaderboard.",
        brief="Shows global leaderboards for coins and prestige.",
    )
    ...
    @commands.command(
        description="Allows you to hunt for items and sell them for coins. The items go to your inventory",
        brief="Allows you to hunt for items and sell them for coins.",
    )
    ...
    @commands.command(
        description="Sell items in your inventory", brief="Sell items in your inventory"
    )
    ...
    @commands.command(
        aliases=["inv"], description="View your inventory", brief="View your inventory"
    )
    ...
    @commands.command(
        ...
        brief="Check information about your country, or another person's country.",
    )
    async def profile(self, ctx, member: discord.Member = None):
        ...
        try:
            ...
            embed.set_footer(
                text=f"Tax your citizens with `{ctx.prefix}tax` to earn coins!"
            )
            ...
            embed = discord.Embed(
                title="Hey!",
                description=f":x: You or the person you are viewing do not have a country! Create one with `{ctx.prefix}start`",
            )
            await ctx.send(embed=embed)
    ...
    @commands.command(
        ...
        brief="Shows you items you can purchase for your country",
    )
    ...
    **2. Apartment (with roomate) ID = `2` Status: [{status}]**
    ...
    @commands.command(
        description="Work and earn population for your country!",
        brief="Work and earn population for your country!",
    )
    ...
    @commands.command(
        description="Prestige your country. This means that your population and multiplier will be reset, but you earn more coins, more multiplier and more population.",
        brief="Prestige your country.",
    )
    async def prestige(self, ctx):
        ...
        if a[0][1] > a[0][6]:
            ...
            embed = discord.Embed(
                title="Oh No",
                description=""":x: you haven't met the requirements to prestige""",
            )
            await ctx.channel.send(embed=embed)

    @commands.command(
        description="Deletes your country :((", brief="Deletes your country :(("
    )
    ...
    @commands.command(
        description="Buy items for your country!", brief="Buy items for your country!"
    )
    ...
    @commands.command(
        ...
        brief="Gift some population to other people!",
    )
    async def gift(self, ctx, user: discord.Member, amount):
        try:
        ...
        if str(user) == str(ctx.message.author):
            embed = discord.Embed(
    ...
    @commands.command(
        description="Change your country name!", brief="Change your country name!"
    )
    async def change(self, ctx, *, name):
        ...
        arg = arg.replace("'", "`")
        await update(
            (ctx.message.author.id, arg, a[0][1], a[0][2], a[0][3], a[0][4], a[0][10])
        )
        embed = discord.Embed(
            title="Success",
    ...
    @commands.command(
        ...
        brief="Get your daily allowance of population...",
    )
...
class Games(commands.Cog, description="Cool games that test your geography skills"):
    ...
    @commands.command(
        ...
        description="Wage war on your friends!",
        brief="Wage war on your friends!",
    )
    ...
    async def war(self, ctx, user: discord.Member):
        ...
        await ctx.channel.send(
            f"<@!{b}>, you have 20 seconds to accept <@!{ctx.message.author.id}> request to war. Type `accept` in the chat to accept, or type `deny` in the chat to end the conflict"
        )
        ...
        def check(m):
            ...
            return (
                ...
                and int(m.author.id) in [int(b), int(ctx.message.author.id)]
            )
        ...
        if msg.author == ctx.author:
            await ctx.channel.send(
                f"<@!{ctx.message.author.id}> you gave the answer first. You won the war!!! :crown:"
            )
            await update_war(
                (
                    ctx.message.author.id,
    ...
    @commands.command(
        description="Guess capitals of countries, or guess countries from their capitals! This game lasts for ten minutes at max!",
        brief="Guess capitals of countries, or guess countries from their capitals!",
    )
            ...
            while time.monotonic() - start < 600:
                ...
                try:
                    msg = await self.bot.wait_for(
                        "message", check=check, timeout=length
                    )
