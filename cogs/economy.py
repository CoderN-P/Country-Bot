...
class CountryEconomy(
    ...
    @commands.command(
        brief="Get the gni per capita of a real country.",
        description="Get the gni per capita of a real country.",
    )
    ...
    @commands.command(
        brief="Get the inflation (in %) of a real country in a certain year.",
