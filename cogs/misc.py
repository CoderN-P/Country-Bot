...
class Misc(commands.Cog, description="Miscellaneous commands"):
    ...
    @commands.command(
        ...
        brief="Learn some cool cat facts!",
    )
    ...
    @commands.command(
        ...
        brief="Learn some cool dog facts!",
    )
    ...
    @commands.command(
        description="Get Country Bot's invite link",
        brief="Get Country Bot's invite link",
    )
    ...
    @commands.command(
        ...
        brief="Get a random joke, or specify a type of joke: `knock-knock`, `general`, or `programming`",
    )
    ...
    @commands.command(
        ...
        brief="Vote for Country Bot to get some cool rewards!",
    )
    ...
    @commands.command(
        description="Get the message ping of the bot.",
        brief="Get the message ping of the bot.",
    )
    ...
    @commands.command(
        ...
        brief="Get information about a color by supplying its rgb/hex",
    )
    ...
    @commands.command(
        description="Country Bot changelog.", brief="Country Bot changelog."
    )
